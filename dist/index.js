...
const os = __importStar(__nccwpck_require__(37));
const transformers = __importStar(__nccwpck_require__(254));
async function run() {
    try {
        const source = core.getInput('source');
        const transforms = core.getInput('transform');
        let result = source;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__nccwpck_require__(737), exports);
__exportStar(__nccwpck_require__(26), exports);
